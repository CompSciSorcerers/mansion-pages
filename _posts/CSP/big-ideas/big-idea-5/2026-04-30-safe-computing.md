---
layout: post
title: 5.6 Safe Computing (Part B)
description: Collection of resourcs for 5.6B focusing on attacks/encryption/privacy
author: TheFlockers (Lucas M)
permalink: /csp/big-idea-5/6-safe-computing/
---

## Resources
- _Privacy On the Web_: [Citizen Lab's report on Webloc surveillance](https://citizenlab.ca/research/analysis-of-penlinks-ad-based-geolocation-surveillance-tech/)
- _Cyberattack Methodologies_: [Wikipedia excerpt](https://en.wikipedia.org/wiki/Cyberattack#Attack_process_and_types)
- _Pubkey Cryptography_: [Asymmetric/Symmetric Cryptography](https://en.wikipedia.org/wiki/Public-key_cryptography#/media/File:Public_key_encryption.svg)
