...
class AstroStory {
    constructor(gameEnv) {
        ...
        const bgData = {
            name: "custom_bg",
            src: path + "/images/projects/astronaut-platformer-game/newgamebg.jpeg",
            pixels: { height: 720, width: 1280 }
        };

        const playerData = {
            id: 'playerData',
            src: path + "/images/projects/astronaut-platformer-game/astro.png",
            SCALE_FACTOR: 5,
            STEP_FACTOR: 1000,
            ANIMATION_RATE: 50,
        ...
        const npcData1 = {
            ...
            src: path + "/images/projects/astronaut-platformer-game/chillguy.png",
            SCALE_FACTOR: 8,
            ANIMATION_RATE: 50,
        ...
        const npcData2 = {
            ...
            src: path + "/images/projects/astronaut-platformer-game/pew.png",
            SCALE_FACTOR: 8,
            ANIMATION_RATE: 50,
        ...
        const sprite_src_chilldude = path + "/images/projects/astronaut-platformer-game/r2_idle.png";
