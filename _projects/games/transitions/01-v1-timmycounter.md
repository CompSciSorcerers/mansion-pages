...
permalink: /sprintingsnails-timmycounter-game
---
...
<script type="module">
    ...
    import GameLevelTimmyfuncounter from "{{site.baseurl}}/assets/js/GameEnginev1/GameLevelTimmyfuncounter.js";
    import { pythonURI, javaURI, fetchOptions } from '{{site.baseurl}}/assets/js/api/config.js';

    const gameLevelClasses = [GameLevelTimmyfuncounter];
