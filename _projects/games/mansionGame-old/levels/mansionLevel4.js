...
class MansionLevel4 {
    constructor(gameEnv) {
        ...
        // Background data
        const image_background = path + "/images/projects/mansionGame-old/image_lvl4.png";
        ...
        // Adding Music
        this.backgroundMusic = new Audio(path + '/assets/sounds/mansionGame-old/SpookieDookie.mp3');
