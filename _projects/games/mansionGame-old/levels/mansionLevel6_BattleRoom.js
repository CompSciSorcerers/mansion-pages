...
class MansionLevel6_BattleRoom {
    constructor(gameEnv) {
        ...
        const sprite_src_body = path + "/images/projects/mansionGame-old/ReaperMainBody.png";
        ...
        const sprite_reaper_src = path + "/images/projects/mansionGame-old/ReaperMainBody.png";
        ...
        const sprite_arm_left_empty = path + "/images/projects/mansionGame-old/ReaperLeftHandEmpty.png";
        const sprite_arm_left_scythe = path + "/images/projects/mansionGame-old/ReaperLeftHandScythe.png";
        const sprite_arm_right_empty = path + "/images/projects/mansionGame-old/ReaperRightHandEmpty.png";
        const sprite_arm_right_scythe = path + "/images/projects/mansionGame-old/ReaperRightHandScythe.png";
        ...
        const sprite_scythe_src = path + "/images/projects/mansionGame-old/fireball.png";
