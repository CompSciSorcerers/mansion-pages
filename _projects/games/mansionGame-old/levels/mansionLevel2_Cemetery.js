...
class MansionLevel2_Cemetery {
  constructor(gameEnv) {
    ...
    // === BACKGROUND SETUP ===
    const backgroundImage = path + "/images/projects/mansionGame-old/CemeteryMainBackground.png";
    ...
    const gravestoneImagePaths = [1, 2, 3, 4, 5, 6].map(num => 
      path + `/images/projects/mansionGame-old/gravestone_${num}.png`
    );
  ...
  showKeyEarnedPopup() {
    ...
    keyImage.src = path + '/images/projects/mansionGame-old/key_lvl3.png';
