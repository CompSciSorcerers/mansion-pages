...
class MansionLevel3 {
  constructor(gameEnv) {
    ...
    this.backgroundY = 0;
    const image_background = path + "/images/projects/mansionGame-old/stairs_lvl3.png";
  ...
  spawnSkeleton() {
    const skeletonData = {
      ...
      level: this,
      isKey: false,
      imageSrc: this.gameEnv.path + "/images/projects/mansionGame-old/skeleton_lvl3.png"
    };
  ...
  spawnKey() {
    const keyData = {
      ...
      level: this,
      isKey: true,
      imageSrc: this.gameEnv.path + "/images/projects/mansionGame-old/key_lvl3.png"
    };
  ...
  winGame() {
    ...
    dialogueSystem.showDialogue(
      ...
      'Victory!',
      this.gameEnv.path + '/images/projects/mansionGame-old/key_lvl3.png'
    );
  ...
  gameOver() {
    ...
    dialogueSystem.showDialogue(
      ...
      'Game Over',
      this.gameEnv.path + '/images/projects/mansionGame-old/skeleton_lvl3.png'
    );
