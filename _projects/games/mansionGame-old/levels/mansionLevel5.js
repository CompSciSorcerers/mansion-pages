...
class MansionLevel5 {
  constructor(gameEnv) {
	...
	// Background data
	const image_background = path + "/images/projects/mansionGame-old/background_lvl5.png"; // be sure to include the path
	...
	//data for player
	const sprite_player = path + "/images/projects/mansionGame-old/full_anims_spook.png"; // be sure to include the path
    ...
    // Level 6 door
    const sprite_src_level6door = path + "/images/projects/mansionGame-old/door_lvl5.png";
    ...
    const laser_image = path + "/images/projects/mansionGame-old/laser_bolt.png"  // be sure to include the path
    this.laserData = {
      id: "Laser",
      src: laser_image,
      SCALE_FACTOR: 20,
