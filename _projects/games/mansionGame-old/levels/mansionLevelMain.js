...
class MansionLevelMain {
  constructor(gameEnv) {
    ...
    // Background data
    const image_src_mainworld = path + "/images/projects/mansionGame-old/mansion_lobby.png"; // be sure to include the path
    ...
    // Player data for MC
    const sprite_src_mc = path + "/images/projects/mansionGame-old/spookMcWalk.png"; // be sure to include the path
    ...
    const sprite_src_level1door = path + "/images/projects/mansionGame-old/lineDoorCollisionSprite.png"; // replace with your door sprite if needed
      ...
      const sprite_src_level3door = path + "/images/projects/mansionGame-old/lineDoorCollisionSprite.png";
      ...
      // Level 4 door
      const sprite_src_level4door = path + "/images/projects/mansionGame-old/lineDoorCollisionSprite.png";
      ...
      // Level 5 door
      const sprite_src_level5door = path + "/images/projects/mansionGame-old/lineDoorCollisionSprite.png";
      ...
      // Level 6 door
      const sprite_src_level6door = path + "/images/projects/mansionGame-old/lineDoorCollisionSprite.png";
      ...
      // Level 2 door
      const sprite_src_level2door = path + "/images/projects/mansionGame-old/lineDoorCollisionSprite.png";
