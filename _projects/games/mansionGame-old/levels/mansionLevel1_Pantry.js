...
class MansionLevel1_Pantry {
  constructor(gameEnv) {
    ...
    // Background data
    const image_background = path + "/images/projects/mansionGame-old/kitchen_pantry.png"; // be sure to include the path
    ...
    const objective_sprite_data = {
        ...
        src: path + "/images/projects/mansionGame-old/objective.png",
  ...
  // small delay so UI updates first, then show a DialogueSystem modal instead of alert
        ...
        try {
          ...
          dsFinal.addButtons([
            ...
            // create the skeleton key image element
              ...
              keyImg.src = '/images/projects/mansionGame-old/skeleton_key.png'; // <-- change this to your actual image path
              ...
              const levelMusic = new Audio(path + "/assets/sounds/mansionGame-old/victory_sound.mp3");
    ...
    function makeItemData(id, filename, initX, initY, scaleFactor = 10) {
      return {
        ...
        src: path + '/images/projects/mansionGame-old/' + filename,
