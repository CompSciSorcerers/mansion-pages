...
class MansionLevel1 {
  ...
  if (gameEnv && gameEnv.gameControl) {
    ...
    if (!gc.levelMusic) {
      gc.levelMusic = new Audio(path + "/assets/sounds/mansionGame-old/shadow_music_level1.mp3");
    ...
    // Background data
    const image_background = path + "/images/projects/mansionGame-old/kitchen_lvl1.png"; // be sure to include the path
    ...
    const sprite_src_mc = path + "/images/projects/mansionGame-old/spookMcWalk.png"; // be sure to include the path
      ...
      const sprite_src_pantrydoor = path + "/images/projects/mansionGame-old/invisDoorCollisionSprite.png"; // replace with your door sprite if needed
