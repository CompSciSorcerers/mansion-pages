// version of GameLevelPatrollingGuard.js using a broken version of Guard.js to show progression in the lesson
import GameEnvBackground from '@assets/js/GameEnginev1/essentials/GameEnvBackground.js';
import Player from '@assets/js/GameEnginev1/essentials/Player.js';
import Npc from '@assets/js/GameEnginev1/essentials/Npc.js';
import GuardBroken from '@assets/js/projects/collisions-mechanic/levels/GuardBroken.js';
...
class GameLevelPatrollingGuard {
    constructor(gameEnv) {
        ...
        this.classes = [      
            ...
            { class: GuardBroken, data: npcData }
        ];
    }
}
